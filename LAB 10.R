...
# Regla 1: mantener n-1 conexiones como máximo (EJ. SI TENEMOS 200 NODOS, LAS CONEXIONES TOTALES VAN A SER 199)
...
#crear una matriz aleatoria de 200*200 (matriz de relacionamiento)
...
#funcion de arbol de expansión máxima (identifica las arista con más conexiones)
          M<- -M
http://127.0.0.1:45315/graphics/plot_zoom_png?width=1366&height=705          head(M[,1:6])
